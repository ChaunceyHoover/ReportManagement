		...
		function _activate() {
			...
			var formattedRequest = {
				...
				'NewOwner': $scope.room.ownerId == 0 ? {
					...
					'level': 2,
					'fName': name.length == 1 ? '' : name[0],
					'lName': name.length == 1 ? name[0] : name[1],
		...
		function _activate() {
			var formattedRequest = {
				'NewSite': {
					...
					'siteOwnerPhone': $scope.room.ownerId == 0 ? ($scope.owner.phone || '') : $scope.room.owner.phone,
				...
				'NewOwner': $scope.room.ownerId == 0 ? {
					...
					'password': $scope.owner.password,
					'level': 2,
					'fName': $scope.owner.fName,
					'lName': $scope.owner.lName,
					'phone': $scope.owner.phone,
					'email': $scope.owner.email,
		...
		function _activate() {
			var formattedRequest = {
				...
				'NewOwner': $scope.room.ownerId == 0 ? {
					...
					'fName': $scope.owner.fName,
					'lName': $scope.owner.lName,
					'phone': $scope.owner.ownerPhone,
					'email': $scope.owner.ownerEmail,
				} : { 'id': $scope.room.ownerId },
				'SiteInstaller': angular.extend({}, $scope.installer),
				'SiteManager': angular.extend({}, $scope.manager),
				'ActivationInfo': {
